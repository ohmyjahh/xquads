...
export default function CodigosSecretosPage() {
  ...
  return <div className="max-w-5xl mx-auto py-8 px-4 space-y-12">
    {review&&<div className="sticky top-2 z-20 rounded-lg bg-[#A3E635] text-[#17200b] text-center text-[10px] font-mono font-semibold px-3 py-2">PRÉVIA LOCAL · conteúdo aberto. Em produção, os 50 códigos ficam protegidos pelo formulário.</div>}
